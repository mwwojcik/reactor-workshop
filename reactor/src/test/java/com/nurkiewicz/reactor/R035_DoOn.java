...
public class R035_DoOn {
    ...
    /*
    Są to metody pomocnicze, do logowania,

    doOnError()- wyjątek pozostaje na strumieniu, to nie służy do obsługi go, tylko do podejrzenia, zalogowania
    podbicia metryki

    lambdy są jednowątkowe nie powinno tu być logiki.

    UWAGA!
    sygnał subscribe wysyłąny jest od dołu do góry, ale potem dane są przetwarzane odwrotnie z góry do dołu.

    np. onError zobaczy tylko te błędy które są ponad nim. Ogromne znaczenie ma miejsce gdzie operator znajduje się w
     strumieniu.
